...
NVIDIA_INSTALLER_IMAGE="factory.talos.dev/installer/${NVIDIA_INSTALLER_ID}:${TALOS_VERSION}" yq -i '.machine.install.image = strenv(NVIDIA_INSTALLER_IMAGE)' alpha.yaml
...
NVIDIA_INSTALLER_IMAGE="factory.talos.dev/installer/${NVIDIA_INSTALLER_ID}:${TALOS_VERSION}" yq -i '.machine.install.image = strenv(NVIDIA_INSTALLER_IMAGE)' gamma.yaml
